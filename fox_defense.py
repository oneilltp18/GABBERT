...
def sixteen_years(range):
        year_urls = ['http://www.foxsports.com/nfl/stats?season='+str(x)+'&week=100&category=DEFENSE&opp=0&sort=2&qualified=0&sortOrder=0&page=' for x in range]
        print year_urls
        loc = 0
...
columns = ['name', 'games', 'tackles', 'solo', 'assisted', 'sacks', 'sack_yds',
            'ints', 'int_yards', 'int_tds', 'long_int', 'forced_fumble', 'fumble_recovery',
            'fumble_tds', 'passes_defensed', 'safety', 'stuffs', 'stuff_yards', 'season']
...
numerics = ['games', 'tackles', 'solo', 'assisted', 'sacks', 'sack_yds',
            'ints', 'int_yards', 'int_tds', 'long_int', 'forced_fumble', 'fumble_recovery',
            'fumble_tds', 'passes_defensed', 'safety', 'stuffs', 'stuff_yards', 'season']
