...
test_stats = strip_stats2(stat_rows)
len(test_stats)
...
# Do a little bit of conversion before uploading this stuff up to sql
...
test_df.to_sql('wide_receivers', engine)
